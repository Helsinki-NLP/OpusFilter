...
class TestTokenization(unittest.TestCase):
    ...
    def test_jieba(self):
        ...
        # The expected word segmentation result is not directly given here, because there is no absolute standard word segmentation result in Chinese.
        # Different versions of the model will output slightly different word segmentation results.
        # So just assert the max lentgh of generated tokens is less than a small value (just use 8 here).
