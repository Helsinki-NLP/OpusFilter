...
setuptools.setup(
    ...
    scripts=["bin/opusfilter", "bin/opusfilter-autogen", "bin/opusfilter-cmd", "bin/opusfilter-diagram",
             "bin/opusfilter-duplicates", "bin/opusfilter-scores", "bin/opusfilter-test"],
